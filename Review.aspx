...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="Title">
        ...
        <section class="form">
         ...
         <div class="form-group">
          <label for="rating">How satisfied were you with the job done by the freelancer/client?</label>
          <fieldset class="rating">
            ...
            <%--<button class="ss_button" type="submit">Submit Feedback</button>--%>
               <asp:Button Class="ss_button" ID="Button1" runat="server"  type="submit" Text="Submit Review"/>
